                    ...
                    <form action="{{ route('reports.add') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="name" class="form-control" value="{{$student->name}}">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12 text-end">
                                        <a href="{{ route('studentinfo',['id' => $student->id]) }}" class="btn btn-secondary me-2"><i class="fa fa-window-close"></i> Cancel</a>
