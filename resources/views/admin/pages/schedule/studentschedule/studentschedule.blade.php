...
@section('content')
    ...
    <div class="container mt-3">
        ...
        @if ($selectStudentSchedule)
         ...
         {{-- <div class="form-group">
            <br>
            <form class="form-inline my-2 my-lg-0" method="get" action="{{ route('studentschedule.search', ['BatchId' => $findBatch->id, 'BlockId' => $block->id]) }}">
                <input class="form-control mr-sm-3" name="search_student" type="search" placeholder="Search">
