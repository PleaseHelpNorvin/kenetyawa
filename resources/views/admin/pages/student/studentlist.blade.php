...
@section('content')
    ...
    @if ($selectedBlock)
        <br>
        <a href="{{ route('add.student', ['batchId' => $batch_id, 'block' => $selectedBlock->id]) }}" class="btn btn-primary">Add Student</a>
    @endif
    ...
    <div class="d-flex align-items-center">
        <a href="{{ route('view.student', ['student' => $student->id]) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
