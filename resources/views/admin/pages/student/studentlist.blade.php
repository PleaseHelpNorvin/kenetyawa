...
<div class="container mt-3">
    ...
    <div class="container-fluid">
        <ul class="navbar-nav">
            @foreach ($batches as $batch)
                <li class="nav-item mr-5">
                    <a href="{{ route('studentview', ['batchId' => $batch->id, 'block' => 'null']) }}" class="nav-link {{ $batch->isSelected ? 'selected-nav-link' : '' }}">{{ $batch->batch_name }}</a>
                </li>
            @endforeach
        </ul>
        ...
        <form action="{{ route('add.batch') }}" method="POST" class="ms-auto">
            ...
            <div class="col-md-6">
                <button type="submit" id="AddBatch" class="btn btn-primary"><i class="fa fa-plus"></i> Batch</button>
            </div>
        </form>
    ...
    @foreach ($students as $student)
        <tr class="{{ $student->status == 'Replacement' ? 'table-warning' : ($student->status == 'Regular' ? 'table-success' : '') }}">
            ...
            <td  class="d-flex justify-content-center align-items-center">
                <div class="d-flex align-items-center">
                    <a href="{{ route('view.student', ['student' => $student->id]) }}" class="btn btn-primary">
